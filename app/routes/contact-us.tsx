      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
        <div className="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">We understand the importance of staying connected with your incarcerated loved ones, and we're here to provide you with the support and assistance you need. If you have any questions, concerns, or need help, please don't hesitate to reach out to us.</p>
            ...
            <h2 className="text-3xl mt-12 font-bold tracking-tight text-gray-900">Sales enquiry</h2>
            <p className="mt-6 text-lg leading-8 text-gray-600">Our dedicated customer support team is here to listen and provide guidance. We know that navigating communication in these challenging circumstances can be overwhelming, but rest assured, we're here to help you every step of the way.</p>
            <p className="mt-6 text-lg leading-8 text-gray-600">If you have any sales-related inquiries or need information about our services, our patient and knowledgeable sales team is ready to assist you. We understand that finding the right communication solutions for your unique situation is important, and we're committed to helping you make informed decisions.</p>
            <p className="mt-6 text-lg leading-8 text-gray-600">We genuinely value your feedback, and we're continuously striving to improve our services to better serve you. If you have any suggestions, comments, or concerns, please share them with us. We appreciate your input and are committed to making your experience with us as smooth and positive as possible.</p>
            <p className="mt-6 text-lg leading-8 text-gray-600">We're here to assist you in any way we can. Please don't hesitate to get in touch with us. Your satisfaction and peace of mind are our top priorities.</p>
            <p className="mt-6 text-lg leading-8 text-gray-600">Or alternatively please fill out the contact form below, and we’ll get back to you as soon as possible.</p>
          </div>
        </div>
